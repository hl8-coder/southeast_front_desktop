...
class GamePlay extends Component {
  ...
  render() {
    const url = decodeURIComponent(this.getQueryParam("url"));
    return <div className={styles["game-play"]}>
      ...
      <div className={styles["btn-group"]}>
        ...
        <div className={styles["group-right"]}>
          <div className={styles["btn-item"]} onClick={this.handleClick}>{intl.get("BTN_TRANSFER_1")}</div>
          <div className={styles["btn-item"]} onClick={this.openLiveChat}>{intl.get("BTN_LIVECHAT")}</div>
        </div>
      </div>
