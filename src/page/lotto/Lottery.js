...
class Lottery extends Component {
  ...
  render() {
    ...
    return <>
      <Helmet>
        <title>{intl.get('SEO_LOTTERY_TITLE')}</title>
        <meta name="description" content={intl.get('SEO_LOTTERY_DESCRIPTION')} />
        <link href={`${window.location.origin}/${window.location.pathname.split("/")[1]}/lottos`} rel="canonical" hrefLang={intl.get('SEO_APP_LANGUAGE')}/>
      </Helmet>
